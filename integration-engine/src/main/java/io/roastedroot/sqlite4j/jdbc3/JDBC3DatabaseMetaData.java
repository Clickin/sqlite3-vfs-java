// Modified for sqlite3-vfs: isolate driver metadata from the native test oracle's resources.
    ...
    static {
        try (InputStream sqliteJdbcPropStream =
                JDBC3DatabaseMetaData.class
                        .getClassLoader()
                        .getResourceAsStream("io/roastedroot/sqlite4j/sqlite-jdbc.properties")) {
