// Modified for sqlite3-vfs: include current xerial automatic-index, spill and checkpoint config.
/**
...
public class SQLiteConfig {
    ...
    public enum Pragma {
        ...
        AUTOMATIC_INDEX(
                "automatic_index", "Allow automatic transient indexes", OnOff.Values),
        CACHE_SIZE(
                "cache_size",
                ...
                null),
        CACHE_SPILL(
                "cache_spill", "Enable dirty-page spilling or set its page threshold", null),
        MMAP_SIZE(
                "mmap_size",
        ...
        APPLICATION_ID(
                ...
                null),
        WAL_AUTOCHECKPOINT(
                "wal_autocheckpoint", "Set the automatic WAL checkpoint interval in pages", null),
